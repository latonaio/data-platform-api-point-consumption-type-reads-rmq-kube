...
import (
	dpfm_api_caller "data-platform-api-point-consumption-type-reads-rmq-kube/DPFM_API_Caller"
	...
	"data-platform-api-point-consumption-type-reads-rmq-kube/config"
	"encoding/json"
	"fmt"
	"time"
